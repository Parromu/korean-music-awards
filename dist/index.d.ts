...
export declare const MMAURL =
  "https://www.melon.com/mma/result.htm?mmaYear=2023";
export declare const KHAURL =
...
export declare const getMMAData: () => Promise<MMADataType[]>;
export declare const getKHAData: () => Promise<KHADataType[]>;
